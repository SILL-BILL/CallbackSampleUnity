...
public class UnityEventTest : MonoBehaviour
{
	...
	void Start () {
		...
		unityEvent.AddListener (new UnityAction(UnityEventCallbackMethod_1));
		unityEvent.AddListener (new UnityAction(UnityEventCallbackMethod_2));
		unityEvent.AddListener (new UnityAction(UnityEventCallbackMethod_3));
